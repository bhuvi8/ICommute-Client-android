...
/**
 * Helper class for showing and canceling new route data
 * notifications.
 * <p/>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class NewRouteDataNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "NewRouteData";
     ...
     * presentation of new route data notifications. Make
     * sure to follow the
